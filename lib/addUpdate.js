...
addRole = () => {
    ...
    .then(answer => {
        ...
        const roleDeptId = `SELECT name, id FROM department`;

        connection.promise().query(roleDeptId, (err, data) => {
            if (err) throw err;
    ...
    .then(answer => {
        ...
        connection.promise().query(roleDeptId, (err, data) => {
            ...
            .then(roleChoice => {
                ...
                connection.promise().query(managerIdTable, (err, data) => {
                    if (err) throw err;
...
updateManager = () => {
    ...
    connection.promise().query(employeeIdTable, (err, data) => {
        if (err) throw err;
        ...
        .then(employeeChoice => {
            ...
            const managerIdTable = `SELECT * FROM emloyee`;
